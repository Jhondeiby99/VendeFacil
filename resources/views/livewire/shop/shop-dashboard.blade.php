<div class="p-4">
    ...
    <flux:modal.trigger class="" :name="'cart-modal'">
        <flux:button  x-data="" x-on:click.prevent="$dispatch('open-modal', 'cart-modal')"
                    class="class="items-center font-medium justify-center gap-2 whitespace-nowrap disabled:opacity-75 dark:disabled:opacity-75 disabled:cursor-default disabled:pointer-events-none h-10 text-sm rounded-lg px-4 inline-flex bg-white hover:bg-zinc-50 dark:bg-zinc-700 dark:hover:bg-zinc-600/75 text-zinc-800 dark:text-white border border-zinc-200 hover:border-zinc-200 border-b-zinc-300/80 dark:border-zinc-600 dark:hover:border-zinc-600 shadow-xs"">
            🛒 {{ count($cart) }}
        </flux:button>
    </flux:modal.trigger>
    </div>
